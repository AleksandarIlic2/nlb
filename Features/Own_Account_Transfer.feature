...
#    And Assert that transaction amount in payment under key "INTERNAL TRANSFER" from txt file is "5,00"
    ...
    #Ovo je varijacija sa Tekuceg racuna. Treba da se odradi sa Aviste na Loan kad budem imao Aviste
  @Payments_Own_Account_Transfer_To_Loan_[WEB]
  Scenario Outline: Payments_Own_Account_Transfer_To_Loan_[WEB]
